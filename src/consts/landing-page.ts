...
import cafeLatteImage from "../assets/menu/cafe-latte.webp";
import parfaitImage from "../assets/menu/parfait.webp";
import teaSetImage from "../assets/menu/tea-set.webp";
